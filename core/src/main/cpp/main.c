...
Java_com_github_kr328_clash_core_bridge_Bridge_nativeInit(JNIEnv *env, jobject thiz, jstring home, jstring version_name, jint sdk_version) {
...
JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeSuspend(JNIEnv *env, jobject thiz, jboolean suspended) {
...
JNIEXPORT jstring JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeStartHttp(JNIEnv *env, jobject thiz, jstring listen_at) {
...
JNIEXPORT jstring JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeQueryGroupNames(JNIEnv *env, jobject thiz, jboolean exclude_not_selectable) {
    scoped_string response = queryGroupNames((int) exclude_not_selectable);
    return new_string(response);
}

JNIEXPORT jstring JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeQueryGroup(JNIEnv *env, jobject thiz, jstring name, jstring mode) {
...
JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeHealthCheck(JNIEnv *env, jobject thiz, jobject completable, jstring name) {
...
Java_com_github_kr328_clash_core_bridge_Bridge_nativePatchSelector(JNIEnv *env, jobject thiz, jstring selector, jstring name) {
...
JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeLoad(JNIEnv *env, jobject thiz, jobject completable, jstring path) {
    jobject _completable = new_global(completable);
...
JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeFetchAndValid(JNIEnv *env, jobject thiz, jobject callback, jstring path, jstring url, jboolean force) {
...
JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeUpdateProvider(JNIEnv *env, jobject thiz, jobject completable, jstring type, jstring name) {
    jobject _completable = new_global(completable);
...
static int call_tun_interface_query_socket_uid_impl(void *tun_interface, int protocol, const char *source, const char *target) {
    ATTACH_JNI();
...
JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    m_tun_interface_query_socket_uid = find_method(c_tun_interface, "querySocketUid", "(ILjava/lang/String;Ljava/lang/String;)I");
    ...
    m_completable_complete_exceptionally = find_method(c_completable, "completeExceptionally", "(Ljava/lang/Throwable;)Z");
    ...
    o_unit = (*env)->GetStaticObjectField(env, c_unit, (*env)->GetStaticFieldID(env, c_unit, "INSTANCE", "Lkotlin/Unit;"));
